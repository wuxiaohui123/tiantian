...
<html>
	...
	<ta:pageloading/>
		...
		bodyStyle="padding:10px 20px 10px 10px;overflow:auto;" withButtonBar="true">
			<ta:box id="departPanel" cssStyle="padding:10px 20px 0px 10px;" columnWidth="0.9" fit="true">	
				...
				<ta:text id="orgname" key="组织名称" maxLength="60"  required="true" columnWidth="0.6" span="2"  labelWidth="115" onChange="fnChange(this)"/>
...
<!-- 				<ta:selectInput id="yab139"  key="数据区"  span="2" labelWidth="115" columnWidth="0.6"  displayValue="codeDESC"  hiddenValue="codeValue"  required="true" /> -->
			...
			<ta:panelButtonBar>
			<ta:submit  url="orgUserMgAction!editOrg.do" isok="true" id="update"  key="保存[S]" onSubmit="fnBeforeUpdateOrg" submitIds="departPanel" hotKey="S" icon="icon-add1" successCallBack="fnRefleshTree" />
...
function fnBeforeUpdateOrg(){
	if(Base.getValue("orgid")=="1"&&Base.getValue("effective")=="1"){
