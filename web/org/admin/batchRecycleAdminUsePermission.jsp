...
<ta:pageloading />
	...
	<ta:panel id="adminPanel" hasBorder="true" expanded="false" fit="true"  bodyStyle="overflow:auto;margin:0px 10px 10px 10px;background:white" bodyClass="linecolor" withButtonBar="true" >
		...
		<ta:panelButtonBar align="right">
			<ta:button id="personalrecyclePermissionsOpBtn" key="保存[S]" hotKey="S" icon="icon-add1" isok="true"  onClick="fnRecyclePermissionsOp()" cssStyle="top:-7px"/>
...
function fnRecyclePermissionsOp(url){
	...
	if (str != "") {
		...
		Base.submit("adminPanel", "adminUserMgAction!recycleAdminUsePermissions.do", {"ids":str,"positionids":Base.getValue("recyclePermissionsPositionids")},null,null,function(){
