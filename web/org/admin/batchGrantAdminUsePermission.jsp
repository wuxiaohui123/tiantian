...
<ta:pageloading />	
	...
	<ta:panel id="adminPanel" fit="true" cols="1" bodyStyle="overflow:auto;margin:0px 10px 10px 10px;background:white;" bodyClass="linecolor" withButtonBar="true" hasBorder="true">
...
function fnRecyclePermissionsOp(url){
	...
	if (str != "") { 
		...
		Base.submit("adminPanel", "adminUserMgAction!grantAdminUsePermissions.do", {"ids":str,"positionids":Base.getValue("grantPermissionsPositionids")},null,null,function(){
