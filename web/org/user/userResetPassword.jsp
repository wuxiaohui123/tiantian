...
<ta:panel id="passInfo" hasBorder="false" expanded="false" fit="true" bodyStyle="padding:10px 10px 0px 0px;" withButtonBar="true">
	<ta:text id="newPassword" key="登录口令" required="true" maxLength="15" type="password"/>
	<ta:text id="rpassword" key="确认口令" required="true" maxLength="15" type="password" validType="compare(this.value, ['=', 'newPassword'])"/>
	<ta:panelButtonBar>
...
function fnSavePass() {
	if (Base.getValue("newPassword") == "")
		...
		Base.submit("passInfo,userGd", "userMgAction!webResetPassword.do", null, null, true, function(){Base.closeWindow("passWin");});
	else
