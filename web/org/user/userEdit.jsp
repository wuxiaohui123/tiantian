...
<html xmlns="http://www.w3.org/1999/xhtml" style="height:100%">
	...
	<body class="no-scrollbar" layout="border" layoutCfg="{leftWidth:240}" style="padding:0px;margin:0px">
		...
		<ta:panel id="userInfo" hasBorder="false" expanded="false" fit="true" bodyStyle="padding:10px 20px 10px 10px;" withButtonBar="true">
				<ta:text id="userid" key="用户编号" readOnly="true" span="2"/>
...
<!-- 				<ta:radiogroup key="性别" collection="SEX" id="sex" cols="2"/> -->
			...
			<ta:panelButtonBar>
				<ta:submit id="updateUserBtn" key="保存[S]" icon="icon-add1" hotKey="S" isok="true" submitIds="userInfo" url="userMgAction!webUpdateUser.do" successCallBack="function(){parent.Base.msgTopTip('修改用户成功');parent.Base.closeWindow('win');}"/>
