...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	...
	<body id="body1" class="no-scrollbar" style="padding:0px;margin:0px;">
		...
		<ta:panel id="panel1" hasBorder="false" expanded="false" fit="true" withButtonBar="true" bodyStyle="overflow:auto;">
			...
			<ta:panelButtonBar>
				<ta:button id="saveScopeOpBtn" key="保存" icon="icon-add1" isok="true"  onClick="fnSaveOp('positionMgAction!saveSharePositions.do')"/>
				<ta:button id="closeOpBtn" key="关闭" icon="icon-no" onClick="parent.Base.closeWindow('sharePosition');" />
			</ta:panelButtonBar>
		</ta:panel>
	</body>
</html>
