...
<%@tag import="com.yinhai.sysframework.util.DESCoderUtil"%>
<%--@doc--%>
...
<%@attribute description='导出按钮控制,1导出向导,2导入向导,例如selectExpButtons="1"表示只显示导出向导' name='selectExpButtons' type='java.lang.String' %>
<%--@doc--%>
<%
...
// }
   if(sqlStatementName != null){
      byte[] encryptData =  DESCoderUtil.encrypt(sqlStatementName.getBytes(), "reYj6fIsWGE=");
      sqlStatementName = DESCoderUtil.encryptBASE64(encryptData).trim();
   }
%>
