...
public class ManagerMgId implements Serializable {
	...
	public ManagerMgId(long positionid, long orgid) {
	...
	public boolean equals(Object other) {
		...
		if (other == null)
			return false;
		if (!(other instanceof ManagerMgId))
			return false;
		ManagerMgId castOther = (ManagerMgId) other;
